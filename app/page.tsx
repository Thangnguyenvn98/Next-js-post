  ...
  return (
    ...
    <main  >
      <div className='flex gap-3 items-center justify-center'>
            <input className="p-3 w-full my-5  border-white text-xs text-black  border-opacity-100 rounded-md" type="text" placeholder="Search for keywords" value={searchValue} onChange={(e)=>setSearchValue(e.target.value)}/>
